/*
  ...
  - You are about to drop the column `photoId` on the `Order` table. All the data in the column will be lost.
...
CREATE TABLE "new_UploadFile" (
    ...
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "orderId" TEXT,
    CONSTRAINT "UploadFile_orderId_fkey" FOREIGN KEY ("orderId") REFERENCES "Order" ("id") ON DELETE SET NULL ON UPDATE CASCADE
);
INSERT INTO "new_UploadFile" ("createdAt", "filename", "id", "mimetype", "path", "size") SELECT "createdAt", "filename", "id", "mimetype", "path", "size" FROM "UploadFile";
